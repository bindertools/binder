  ...
  const menus: Menu[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { kind: 'separator' },
        { kind: 'action', label: 'Copy Line Up',        shortcut: 'Shift+Alt+Up',    run: () => trigger('editor.action.copyLinesUpAction') },
        { kind: 'action', label: 'Copy Line Down',      shortcut: 'Shift+Alt+Down',  run: () => trigger('editor.action.copyLinesDownAction') },
        { kind: 'action', label: 'Move Line Up',        shortcut: 'Alt+Up',          run: () => trigger('editor.action.moveLinesUpAction') },
        { kind: 'action', label: 'Move Line Down',      shortcut: 'Alt+Down',        run: () => trigger('editor.action.moveLinesDownAction') },
        { kind: 'separator' },
        { kind: 'action', label: 'Add Cursor Above',    shortcut: 'Ctrl+Alt+Up',     run: () => trigger('editor.action.insertCursorAbove') },
        { kind: 'action', label: 'Add Cursor Below',    shortcut: 'Ctrl+Alt+Down',   run: () => trigger('editor.action.insertCursorBelow') },
        { kind: 'action', label: 'Expand Selection',    shortcut: 'Shift+Alt+Right', run: () => trigger('editor.action.smartSelect.expand') },
        { kind: 'action', label: 'Shrink Selection',    shortcut: 'Shift+Alt+Left',  run: () => trigger('editor.action.smartSelect.shrink') },
      ],
    },
    {
      label: 'View',
    ...
    },
    {
      ...
      items: [
        ...
        { kind: 'separator' },
        { kind: 'action', label: 'Go Back',             shortcut: 'Alt+Left',      run: () => trigger('workbench.action.navigateBack') },
        { kind: 'action', label: 'Go Forward',          shortcut: 'Alt+Right',     run: () => trigger('workbench.action.navigateForward') },
      ],
    },
  ]
